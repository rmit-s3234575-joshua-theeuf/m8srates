...
class Listing < ApplicationRecord
  ...
  validates_numericality_of :number_of_loans, :only_integer => true, :greater_than_or_equal_to => 1, :message => "Must have at least 1 loan.", :allow_nil => true
  validates_numericalilty_of :loan_repayed, :only_integer=>true, :equal_to=>1,:allow_nil=>true
