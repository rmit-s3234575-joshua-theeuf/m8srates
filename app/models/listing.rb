...
class Listing < ApplicationRecord
  ...
  validates_numericality_of :number_of_loans, :only_integer => true, :greater_than_or_equal_to => 0, :message => "Interest must be a numeric value between 0 and 100.", :allow_nil => true
